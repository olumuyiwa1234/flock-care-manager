...
export const Route = createFileRoute("/_authenticated/suggestions")({
  head: () => ({
    meta: [
      { title: "Suggestions — Shepherd" },
      { name: "description", content: "Share ideas and suggestions to help your church community grow." },
      { property: "og:title", content: "Suggestions — Shepherd" },
      { property: "og:description", content: "Send a suggestion to the church leadership." },
    ],
  }),
...
function Suggestions() {
  ...
  return (
    <AppShell title="Suggestion" subtitle="Share your ideas" back="/home">
      ...
      {listQuery.isLoading ? (
        ...
        <EmptyState title="No suggestions yet" hint="Your suggestions will appear here." />
      ) : (
